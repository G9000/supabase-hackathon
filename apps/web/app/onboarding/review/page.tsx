    ...
    <OnboardingLayout {...config}>
      <div className="flex flex-col md:flex-row text-left gap-5 w-screen overflow-auto items-center justify-center py-8">
        ...
        <div className="border border-foreground/3 rounded-3xl p-6 w-[242px] flex-shrink-0 rotate-2">
          <div className="flex flex-row items-start justify-between">
            <Image
              ...
              width={48}
            />
            <div className="px-4 py-1 bg-foreground/5 text-foreground/60 rounded-full font-bold text-base">Edit</div>
          </div>
          <div className="mt-3 mb-2 text-foreground/50">You crave for</div>
          <div className="font-extrabold text-xl leading-6 bg-gradient-to-r from-[#080808CC] to-[#0808088F] text-transparent bg-clip-text">Ramen, Sushi, and Sashimi</div>
        </div>
        ...
        <div className="border border-foreground/3 rounded-3xl p-6 w-[242px] flex-shrink-0 rotate-2">
          ...
          <div className="mt-3 mb-2 text-foreground/50">Your diet or restrictions</div>
          <div className="font-extrabold text-xl leading-6 bg-gradient-to-r from-[#080808CC] to-[#0808088F] text-transparent bg-clip-text">Ramen, Sushi, and Sashimi</div>
        </div>
        ...
        <div className="border border-foreground/3 rounded-3xl p-6 w-[242px] flex-shrink-0 -rotate-2">
          ...
          <div className="mt-3 mb-2 text-foreground/50">Your cuisine preference</div>
          <div className="font-extrabold text-xl leading-6 bg-gradient-to-r from-[#080808CC] to-[#0808088F] text-transparent bg-clip-text">Ramen, Sushi, and Sashimi</div>
        </div>
      </div>

      <p className="text-sm leading-5 mb-4 text-foreground/50 max-w-[277px] text-center">Feel free to adjust further or if you have more details you’d like to include! If you’re ready to roll, let’s continue</p>
